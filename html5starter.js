jsonHash[divHTML.id].c=[
    {
        ...
        "onclick": "var val=window.parent.htmlUnEscape(prompt('Enter HTML',window.parent.blankHTML.replace(/&amp;quot;/g,'\'')));if(val!=null){window.parent.blankHTML=val;window.parent.jsonHash[window.parent.divHTML.id].c[0].blankHTML=val;setTimeout(function(){window.parent.Render(false);},10);}return false;"
    },
    {
        "e": "META",
        "id": "METACharset",
